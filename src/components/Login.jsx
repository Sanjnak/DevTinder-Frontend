          ...
          <div  className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="input bg-base-200 border border-base-300 text-white placeholder:text-base-content/30 w-full rounded-lg h-12 px-4 focus:outline-none focus:border-white/40"
                required
              />
            </div>
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="input bg-base-200 border border-base-300 text-white placeholder:text-base-content/30 w-full rounded-lg h-12 px-4 pr-12 focus:outline-none focus:border-white/40"
                  required
                />
                {/* Toggle icon */}
                <button
